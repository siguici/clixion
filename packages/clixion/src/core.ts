...
export class Command {
  ...
  argument(
    name: string,
    options?: ArgumentConfig
  ): this | ArgumentConfig | undefined {
...
> {
  ...
  getAlias(shortOrLongName: string): Alias | undefined {
    return this.aliases
      ...
      .find(
        (alias) =>
          alias.shortName === shortOrLongName ||
          alias.longName === shortOrLongName
      );
  }
